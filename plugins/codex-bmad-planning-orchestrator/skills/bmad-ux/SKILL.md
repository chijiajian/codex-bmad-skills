...
Use `../bmad-ux/templates/design.template.md`.
...
```bash
bash "../bmad-ux/scripts/wcag-checklist.sh"
```

Check specific color pairs with:

```bash
python "../bmad-ux/scripts/contrast-check.py" #foreground #background
```

Verify responsive breakpoint rules:

```bash
bash "../bmad-ux/scripts/responsive-breakpoints.sh"
```

## EXPERIENCE.md — User Experience Plan

Use `../bmad-ux/templates/experience.template.md`.
...
> ---
> Part of the **BMAD Planning & Orchestrator** plugin — a Codex harness for the **BMAD Method** by the **BMAD Code Organization** (https://github.com/bmad-code-org/BMAD-METHOD). Implements the spirit of `bmad-ux-designer`. All methodology credit belongs to the BMAD Code Organization.
