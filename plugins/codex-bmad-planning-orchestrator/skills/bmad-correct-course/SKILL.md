...
After this skill has triggered, inspect whether any of these signals apply:
...
- `../../scripts/scope-conflict-check.sh` — validate Owned Scope after story changes.
- Downstream: `bmad-epics-and-stories`, `bmad-sprint-planning`, `bmad-parallel-plan`.

> ---
> Part of the **BMAD Planning & Orchestrator** plugin — a Codex harness for the **BMAD Method** by the **BMAD Code Organization** (https://github.com/bmad-code-org/BMAD-METHOD). Implements the spirit of `bmad-correct-course`. All methodology credit belongs to the BMAD Code Organization.
