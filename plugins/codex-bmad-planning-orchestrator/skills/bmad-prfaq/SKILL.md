...
Use the template at `../bmad-prfaq/templates/prfaq.template.md`.
...
> Part of the **BMAD Planning & Orchestrator** plugin — a Codex harness for the **BMAD Method** by the **BMAD Code Organization** (https://github.com/bmad-code-org/BMAD-METHOD). Implements the spirit of `bmad-prfaq`. All methodology credit belongs to the BMAD Code Organization.
