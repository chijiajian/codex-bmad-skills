...
```bash
bash "../bmad-readiness-check/scripts/readiness-check.sh" <output-folder>
```
...
```
../bmad-readiness-check/templates/readiness-report.template.md
```
...
> ---
> Part of the **BMAD Planning & Orchestrator** plugin — a Codex harness for the **BMAD Method** by the **BMAD Code Organization** (https://github.com/bmad-code-org/BMAD-METHOD). Implements the spirit of `bmad-check-implementation-readiness`. All methodology credit belongs to the BMAD Code Organization.
