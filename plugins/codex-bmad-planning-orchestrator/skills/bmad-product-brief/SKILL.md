...
```
bash ../bmad-product-brief/scripts/validate-brief.sh <path-to-brief>
```
...
- `../bmad-product-brief/templates/product-brief.template.md` — Brief template
- `../bmad-product-brief/scripts/validate-brief.sh` — Completeness validator
- `../bmad-product-brief/scripts/discovery-checklist.sh` — Full question list (printable)

---

> ---
> Part of the **BMAD Planning & Orchestrator** plugin — a Codex harness for the **BMAD Method** by the **BMAD Code Organization** (https://github.com/bmad-code-org/BMAD-METHOD). Implements the spirit of `bmad-business-analyst`. All methodology credit belongs to the BMAD Code Organization.
