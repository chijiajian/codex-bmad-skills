...
```bash
bash "../bmad-brainstorm/scripts/scamper-prompts.sh" "your topic"
```

Generate a SWOT analysis scaffold:

```bash
bash "../bmad-brainstorm/scripts/swot-template.sh" "your subject" > bmad-output/swot-draft.md
```
...
> ---
> Part of the **BMAD Planning & Orchestrator** plugin — a Codex harness for the **BMAD Method** by the **BMAD Code Organization** (https://github.com/bmad-code-org/BMAD-METHOD). Implements the spirit of `bmad-brainstorming`. All methodology credit belongs to the BMAD Code Organization.
